...
<center><DIV class = "border" style="border: 3px solid grey;padding:30px; width:50%; height: 40%" >
<h1><center>Upload Image</center></h1>
<!--Form go the customer request form -->
<form action="Mng_Dashboard.php" method="post" enctype="multipart/form-data">
...
<tr><td>Upload your profile picture:</td><td><input type = "file" name = "mng_picture"></td></tr>
</table>
